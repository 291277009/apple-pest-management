...
public class RedisUtil {
    ...
    /**
     * 通过key获取存在redis中的value
     * @param key
     * @param indexdb 数据库选择（0-15）
     * @return
     */
     ...
     * @return 成功个数
     */
    public long del(int indexdb, byte[]... bytes) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
